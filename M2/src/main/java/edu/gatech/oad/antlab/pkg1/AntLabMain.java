 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Kyle Suter");
		  toPrint += p1.toString("ksuter6");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Kevin Liao");
		  toPrint += p2.toString("kliao36");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Charles Hall");
		  toPrint += p3.toString("chall68");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Brian Glowniak");
                  toPrint += p4.toString("bglowniak3");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Spencer Gold");
                  toPrint += p5.toString("sgold9");
